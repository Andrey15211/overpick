...
export async function generateMetadata({ 
  ...
  return {
    ...
    description: `Узнай, кто контрит ${hero.nameRu} в Overwatch 2. Лучшие контрпики и мета-заметки для Season 2: Summit после bug fix-патча Blizzard от 26 мая 2026 года, актуально на 16 июня 2026 года.`,
  };
}
