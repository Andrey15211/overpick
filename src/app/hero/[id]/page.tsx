...
export async function generateMetadata({ 
  ...
  return {
    ...
    description: `Узнай, кто контрит ${hero.nameRu} в Overwatch 2. Лучшие контрпики и мета-заметки для Season 2: Summit после обновления Blizzard от 28 апреля 2026 года, актуально на 20 мая 2026 года.`,
  };
}
