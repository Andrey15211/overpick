...
export const metadata: Metadata = {
  ...
  description: 'Фильтруемый тир-лист героев Overwatch для Season 2: Summit после hotfix от 21 мая 2026 года: статистика Blizzard, свежие tier-листы и pro/high-rank сигналы по состоянию на 25 мая 2026 года.',
};
      ...
      <div className={styles.metaContainer}>
        ...
        <header className={styles.metaHeader}>
          ...
          <p className={styles.metaSubtitle}>
            Тир-лист героев Overwatch на основе статистики Blizzard, свежих экспертных tier-листов и pro/high-rank меты с учетом hotfix от 21 мая 2026 года. Срез актуален на 25 мая 2026 года.
          </p>
