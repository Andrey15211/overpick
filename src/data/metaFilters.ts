...
export const META_SOURCE_NOTES = [
  ...
  },
  {
    ...
    url: 'https://overwatch.blizzard.com/en-us/news/patch-notes/pc%20/',
...
export const HERO_META_SIGNALS: Record<string, HeroMetaSignal> = {
  ...
  vendetta: { expertTier: 'S', proSignal: 2, notes: 'После нерфов всё ещё сильна; hotfix 23 апреля вернул часть выживаемости.', sourceIds: ['blizzard-2026-04-23', 'pcgamer-2026-04-23', 'playerauctions-2026-04-16'], highRankBias: 0.03 },
